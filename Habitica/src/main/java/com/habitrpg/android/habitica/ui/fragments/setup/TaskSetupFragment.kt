...
class TaskSetupFragment : BaseFragment() {
    ...
    private fun setTasks() {
        ...
        this.tasks = listOf(listOf("work", TaskType.TYPE_HABIT, getString(R.string.setup_task_work_1), true, false), listOf("work", TaskType.TYPE_DAILY, getString(R.string.setup_task_work_2)), listOf("work", TaskType.TYPE_TODO, getString(R.string.setup_task_work_3)),
                listOf("exercise", TaskType.TYPE_HABIT, getString(R.string.setup_task_exercise_1), true, false), listOf("exercise", TaskType.TYPE_DAILY, getString(R.string.setup_task_exercise_2)), listOf("exercise", TaskType.TYPE_TODO, getString(R.string.setup_task_exercise_3)),
                listOf("healthWellness", TaskType.TYPE_HABIT, getString(R.string.setup_task_healthWellness_1), true, true), listOf("healthWellness", TaskType.TYPE_DAILY, getString(R.string.setup_task_healthWellness_2)), listOf("healthWellness", TaskType.TYPE_TODO, getString(R.string.setup_task_healthWellness_3)),
                listOf("school", TaskType.TYPE_HABIT, getString(R.string.setup_task_school_1), true, true), listOf("school", TaskType.TYPE_DAILY, getString(R.string.setup_task_school_2)), listOf("school", TaskType.TYPE_TODO, getString(R.string.setup_task_school_3)),
                listOf("teams", TaskType.TYPE_HABIT, getString(R.string.setup_task_teams_1), true, false), listOf("teams", TaskType.TYPE_DAILY, getString(R.string.setup_task_teams_2)), listOf("teams", TaskType.TYPE_TODO, getString(R.string.setup_task_teams_3)),
                listOf("chores", TaskType.TYPE_HABIT, getString(R.string.setup_task_chores_1), true, false), listOf("chores", TaskType.TYPE_DAILY, getString(R.string.setup_task_chores_2)), listOf("chores", TaskType.TYPE_TODO, getString(R.string.setup_task_chores_3)),
                listOf("creativity", TaskType.TYPE_HABIT, getString(R.string.setup_task_creativity_1), true, false), listOf("creativity", TaskType.TYPE_DAILY, getString(R.string.setup_task_creativity_2)), listOf("creativity", TaskType.TYPE_TODO, getString(R.string.setup_task_creativity_3)))
    }
