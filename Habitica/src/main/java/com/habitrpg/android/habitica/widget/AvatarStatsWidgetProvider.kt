...
class AvatarStatsWidgetProvider : BaseWidgetProvider() {
    ...
    private fun updateData(user: User?) {
        ...
        for (widgetId in allWidgetIds) {
            ...
            remoteViews.setViewVisibility(R.id.mp_wrapper, if (showManaBar && (stats.habitClass == null || (stats.lvl ?: 0) < 10 || user.preferences?.isDisableClasses == true)) View.GONE else View.VISIBLE)
