...
open class ShopItemUnlockCondition :
    RealmObject(),
    BaseObject {
    ...
    fun readableUnlockCondition(context: Context): String =
        when (this.condition) {
            "party invite" -> {
                context.getString(R.string.party_invite)
            }
    ...
    fun shortReadableUnlockCondition(context: Context): String =
        when (this.condition) {
            "party invite" -> {
                context.getString(R.string.party_invite_short)
            }
            ...
            "create account" -> {
                context.getString(R.string.create_account_short)
            }
