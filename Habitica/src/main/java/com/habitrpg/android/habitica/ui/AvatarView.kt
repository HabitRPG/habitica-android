...
class AvatarView : View {
    ...
    private var avatar: com.habitrpg.shared.habitica.Avatar? = null
    ...
    private fun getLayerMap(avatar: com.habitrpg.shared.habitica.Avatar, resetHasAttributes: Boolean): Map<LayerType, String> {
    ...
    private fun getAvatarLayerMap(avatar: com.habitrpg.shared.habitica.Avatar, substitutions: Map<String, Map<String, String>>): EnumMap<LayerType, String> {
    ...
    fun setAvatar(avatar: com.habitrpg.shared.habitica.Avatar) {
