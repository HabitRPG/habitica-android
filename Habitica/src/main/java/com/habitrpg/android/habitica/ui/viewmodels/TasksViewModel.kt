...
class TasksViewModel
    ...
    constructor(
        ...
        fun getFilterSet(type: TaskType): MutableLiveData<Triple<String?, String?, List<String>>>? = filterSets[type]
        ...
        override fun canScoreTask(task: Task): Boolean =
            !task.isGroupTask || task.isAssignedToUser(userViewModel.userID) || task.group?.assignedUsers?.isEmpty() != false
