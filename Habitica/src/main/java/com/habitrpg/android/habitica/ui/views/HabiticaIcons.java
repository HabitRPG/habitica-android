...
/**
 * Created by Phillip Thelen on 4. Sep 2020.
...
public class HabiticaIcons {
    ...
    public static void drawItemIndicator(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor, boolean isLocked, boolean isLimited, boolean isDark) {
        ...
        // Local Variables
        int itemIndicatorColor = isLocked ? (isDark ? indicatorLockedDark : indicatorLocked) : (isLimited ? strokeColor : (isDark ? indicatorLockedDark : fillColor38));
    ...
    private static void drawItemIndicatorNumber(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        ...
        symbolTargetRect.set(0f, 0f, symbolRect.width(), symbolRect.height());
        HabiticaIcons.drawItemIndicator(canvas, symbolTargetRect, ResizingBehavior.Stretch, lockColor, false, false, false);
        canvas.restore();
    ...
    public static void drawSpookyGemPromoBG(Canvas canvas, RectF targetFrame, ResizingBehavior resizing) {
        ...
        // Rectangle
        RectF rectangleRect = CacheForSpookyGemPromoBG.rectangleRect;
        rectangleRect.set(-199f, -765f, 161f, 404f);
        Path rectanglePath = CacheForSpookyGemPromoBG.rectanglePath;
        rectanglePath.reset();
        rectanglePath.addRect(rectangleRect, Path.Direction.CW);
    ...
    private static void drawItemIndicatorNumberDark(Canvas canvas, int lockColor) {
        HabiticaIcons.drawItemIndicatorNumberDark(canvas, new RectF(0f, 0f, 28f, 28f), ResizingBehavior.AspectFit, lockColor);
    }
    
    private static void drawItemIndicatorNumberDark(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int lockColor) {
        // Resize to Target Frame
        canvas.save();
    ...
    public static Bitmap imageOfItemIndicatorNumberDark(int lockColor) {
        ...
        HabiticaIcons.drawItemIndicatorNumberDark(canvas, lockColor);
