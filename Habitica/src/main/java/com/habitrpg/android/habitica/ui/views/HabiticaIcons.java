...
/**
 * Created by Phillip Thelen on 29. Jan 2018.
...
public class HabiticaIcons {
    ...
    public static void drawQuestBackground(Canvas canvas, int bossColorDark, int bossColorMedium, int bossColorLight) {
        HabiticaIcons.drawQuestBackground(canvas, new RectF(0f, 0f, 21f, 21f), ResizingBehavior.AspectFit, bossColorDark, bossColorMedium, bossColorLight);
    }
    
    public static void drawQuestBackground(Canvas canvas, RectF targetFrame, ResizingBehavior resizing, int bossColorDark, int bossColorMedium, int bossColorLight) {
        // General Declarations
        Paint paint = CacheForQuestBackground.paint;
        
        // Resize to Target Frame
        canvas.save();
        RectF resizedFrame = CacheForQuestBackground.resizedFrame;
        HabiticaIcons.resizingBehaviorApply(resizing, CacheForQuestBackground.originalFrame, targetFrame, resizedFrame);
        canvas.translate(resizedFrame.left, resizedFrame.top);
        canvas.scale(resizedFrame.width() / 21f, resizedFrame.height() / 21f);
        
        // Rectangle
        RectF rectangleRect = CacheForQuestBackground.rectangleRect;
        rectangleRect.set(0f, 0f, 21f, 21f);
        ...
        // Group
        {
            ...
            rectangle2Rect.set(2f, 13f, 8f, 19f);
            ...
            rectangle3Rect.set(4f, 15f, 6f, 17f);
        ...
        // Group 2
        {
            ...
            rectangle4Rect.set(2f, 2f, 8f, 8f);
            ...
            rectangle5Rect.set(4f, 4f, 6f, 6f);
        ...
        // Group 3
        {
            ...
            rectangle6Rect.set(13f, 2f, 19f, 8f);
            ...
            rectangle7Rect.set(15f, 4f, 17f, 6f);
        ...
        // Group 4
        {
            ...
            rectangle8Rect.set(13f, 13f, 19f, 19f);
            ...
            rectangle9Rect.set(15f, 15f, 17f, 17f);
        ...
        rectangle10Rect.set(17f, 10f, 19f, 11f);
        ...
        rectangle11Rect.set(10f, 17f, 11f, 19f);
        ...
        rectangle12Rect.set(10f, 2f, 11f, 4f);
        ...
        rectangle13Rect.set(10f, 4f, 11f, 17f);
        ...
        rectangle14Rect.set(4f, 10f, 17f, 11f);
        ...
        rectangle15Rect.set(2f, 10f, 4f, 11f);
    ...
    public static Bitmap imageOfQuestBackground(int bossColorDark, int bossColorMedium, int bossColorLight) {
        Bitmap imageOfQuestBackground = Bitmap.createBitmap(21, 21, Bitmap.Config.ARGB_8888);
