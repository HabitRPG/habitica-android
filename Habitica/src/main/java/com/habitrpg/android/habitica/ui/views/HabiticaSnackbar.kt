...
class HabiticaSnackbar
    private constructor(
        ...
        private class ContentViewCallback(
        ...
        companion object {
            ...
            fun showSnackbar(
                ...
                when (displayType) {
                    SnackbarDisplayType.FAILURE -> {
                        snackbar.setBackgroundResource(R.drawable.snackbar_background_red)
                    }

                    SnackbarDisplayType.BLACK -> {
                        snackbar.setBackgroundResource(R.drawable.snackbar_background_black)
                    }
