...
class SetupCustomizationRepositoryImpl @Inject constructor(
    private val context: Context
) : SetupCustomizationRepository {

    private fun wheelchairs(): List<SetupCustomization> = listOf(
    ...
    private fun glasses(): List<SetupCustomization>
         = listOf(SetupCustomization.createGlasses("", R.drawable.creator_blank_face),
                SetupCustomization.createGlasses("eyewear_special_blackTopFrame",
    ...
    private fun flowers(): List<SetupCustomization>
        = listOf(
    ...
    private fun hairColors(): List<SetupCustomization>
         = listOf(
    ...
    private fun sizes(): List<SetupCustomization>
         = listOf(
    ...
    private fun skins(): List<SetupCustomization>
         = listOf(
