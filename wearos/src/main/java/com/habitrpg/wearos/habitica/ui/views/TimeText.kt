...
class TimeText
    ...
    constructor(
         ...
         */
        private val timeBroadcastReceiverFilter =
            IntentFilter().apply {
        ...
        private val timeBroadcastReceiver =
        ...
        init {
            ...
            context
                .obtainStyledAttributes(attrs, R.styleable.TimeText, defStyleAttr, defStyleRes)
                .use { typedArray ->
                    titleTextColor =
        ...
        override fun onMeasure(
            ...
            when (timeTextViewBinding) {
                is TimeTextCurvedViewBinding -> {
                    ...
                    val clockSweepAngle =
                        timeTextViewBinding.timeTextClock.view.sweepAngleDegrees
                            .coerceAtLeast(0f)

                    // Avoid getting the divider sweep angle if it is gone, since it won't be accurate
                    val dividerSweepAngle =
                        if (timeTextViewBinding.timeTextDivider.view.isGone) {
                            0f
                        } else {
                            timeTextViewBinding.timeTextDivider.view.sweepAngleDegrees
                                .coerceAtLeast(0f)
                        }
